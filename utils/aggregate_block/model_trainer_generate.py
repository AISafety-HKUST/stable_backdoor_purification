...
from torchvision.models.resnet import resnet50, resnet34 # resnet34
...
def generate_cls_model(
    ...
    if model_name == 'resnet18':
        ...
        net.head = nn.Linear(in_features=768, out_features=num_classes, bias=True)
    ...
    elif model_name == 'densenet-bc':
        
        from models import DenseNet3
        net = DenseNet3(100, num_classes, 12, reduction=1.0,
