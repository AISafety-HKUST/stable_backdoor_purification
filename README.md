...
```
You can customize the training process by modifying the config files. For example, you can replace the default model architecture by modifying the "model" field in the [prototype](config/attack/prototype)
